...
namespace Stardust.OpenSource.SolidControls.Wpf
{
    ...
    internal sealed class LineChartKernel : Shape
    {
        ...
        public UIElementCollection XSliders { get; }
        public UIElementCollection YSliders { get; }

        #endregion

        public LineChartKernel() {
            XSliders = new UIElementCollection(this, this);
            YSliders = new UIElementCollection(this, this);
        ...
        private void InvalidateDataImage() {
            ...
            Task.Factory.StartNew(() => {
                ...
                Parallel.For(1, points.Count, i => {
                    LineGeneratorUtils.BresenhamLineGenerator(points[i - 1].Convert(), points[i].Convert(), (x, y) => {
